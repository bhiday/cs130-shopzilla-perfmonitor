...
import com.shopzilla.perfmonitor.data.CompositePerfDataDataOnDemand;
...
privileged aspect CompositePerfDataIntegrationTest_Roo_IntegrationTest {
    ...
    public void CompositePerfDataIntegrationTest.testCountCompositePerfDatas() {
        ...
        long count = com.shopzilla.perfmonitor.data.CompositePerfData.countCompositePerfDatas();
    ...
    public void CompositePerfDataIntegrationTest.testFindCompositePerfData() {
        com.shopzilla.perfmonitor.data.CompositePerfData obj = dod.getRandomCompositePerfData();
        ...
        obj = com.shopzilla.perfmonitor.data.CompositePerfData.findCompositePerfData(id);
    ...
    public void CompositePerfDataIntegrationTest.testFindAllCompositePerfDatas() {
        ...
        java.util.List<com.shopzilla.perfmonitor.data.CompositePerfData> result = com.shopzilla.perfmonitor.data.CompositePerfData.findAllCompositePerfDatas();
    ...
    public void CompositePerfDataIntegrationTest.testFindCompositePerfDataEntries() {
        ...
        java.util.List<com.shopzilla.perfmonitor.data.CompositePerfData> result = com.shopzilla.perfmonitor.data.CompositePerfData.findCompositePerfDataEntries(0, (int) count);
    ...
    public void CompositePerfDataIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyCompositePerfData(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.shopzilla.perfmonitor.data.CompositePerfData merged = (com.shopzilla.perfmonitor.data.CompositePerfData) obj.merge();
        obj.flush();
    ...
    public void CompositePerfDataIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'CompositePerfData' failed to initialize correctly", dod.getRandomCompositePerfData());
        com.shopzilla.perfmonitor.data.CompositePerfData obj = dod.getNewTransientCompositePerfData(Integer.MAX_VALUE);
    ...
    public void CompositePerfDataIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'CompositePerfData' with identifier '" + id + "'", com.shopzilla.perfmonitor.data.CompositePerfData.findCompositePerfData(id));
    }
